			...
			<Card.Content class="flex flex-col gap-4">
				...
				<div class="grid grid-cols-2 gap-4">
					<div class="flex flex-col gap-1.5">
						...
						<Input id="firstName" name="firstName" placeholder="Jane" value={values.firstName ?? ''} class={errors.firstName ? 'border-destructive' : ''} />
					...
					<div class="flex flex-col gap-1.5">
						...
						<Input id="lastName" name="lastName" placeholder="Smith" value={values.lastName ?? ''} class={errors.lastName ? 'border-destructive' : ''} />
				...
				<div class="grid grid-cols-2 gap-4">
					<div class="flex flex-col gap-1.5">
						...
						<Input id="role" name="role" placeholder="Software Engineer" value={values.role ?? ''} class={errors.role ? 'border-destructive' : ''} />
						{#if errors.role}<p class="text-[12px] text-destructive">{errors.role}</p>{/if}
					</div>
					<div class="flex flex-col gap-1.5">
						<Label for="country" class="text-[13px]">Country</Label>
						<select id="country" name="country" class="{selectClass} {errors.country ? 'border-destructive' : ''}">
		...
		<Card.Root>
			...
			<Card.Content class="flex flex-col gap-4">
				...
				<div class="flex flex-col gap-1.5">
					...
					<Input id="microsoftEmail" name="microsoftEmail" type="email" placeholder="jane.smith@company.com" value={values.microsoftEmail ?? ''} class={errors.microsoftEmail ? 'border-destructive' : ''} />
				...
				<div class="flex flex-col gap-1.5">
					...
					<Input id="personalEmail" name="personalEmail" type="email" placeholder="jane@gmail.com" value={values.personalEmail ?? ''} />
				</div>
				...
				<div class="flex flex-col gap-1.5">
					...
					<div class="flex gap-2">
						<Input id="tempPassword" name="tempPassword" type="text" placeholder="Auto-generate or enter manually" bind:value={tempPassword} class="font-mono text-[13px]" />
			...
			<Card.Content class="flex flex-col gap-4">
				...
				<div class="grid grid-cols-2 gap-4">
					<div class="flex flex-col gap-1.5">
						...
						<Input id="startDate" name="startDate" type="date" value={values.startDate ?? ''} class={errors.startDate ? 'border-destructive' : ''} />
